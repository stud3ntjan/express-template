...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { DeviceInfoController } from './../src/controllers/deviceInfoController';
...
const models: TsoaRoute.Models = {
    ...
    "DeviceInfo": {
        ...
        "properties": {
            "userId": {"dataType":"string","required":true},
            "baseOS": {"dataType":"string","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/deviceinfo/add',
            ...(fetchMiddlewares<RequestHandler>(DeviceInfoController)),
            ...(fetchMiddlewares<RequestHandler>(DeviceInfoController.prototype.addDeviceInfo)),

            async function DeviceInfoController_addDeviceInfo(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    deviceInfo: {"in":"body","name":"deviceInfo","required":true,"ref":"DeviceInfo"},
            };
